...
abstract class DateHelper {
  ...
  static List<List<DateTime>> getMonths(
    ...
    for (var i = 0; i < monthCount; i++) {
      if (i == monthCount - 1) {
        months.add(<DateTime>[
          DateTime(initialDate.year, initialDate.month + i, initialDate.day),
          DateTime(endDate.year, endDate.month + i, endDate.day),
        ]);
      } else if (i == 0) {
        months.add(<DateTime>[
          DateTime(initialDate.year, initialDate.month + i, initialDate.day),
          DateTime(initialDate.year, initialDate.month + i + 1, 0),
        ]);
        ...
        months.add(<DateTime>[
          DateTime(initialDate.year, initialDate.month + i),
          DateTime(initialDate.year, initialDate.month + i + 1, 0),
        ]);
      }
    }
  ...
  static int getDifferenceInDays(DateTime initialDate, DateTime endDate) {
    return DateTime(
      ...
      initialDate.month,
      initialDate.day,
    ).difference(DateTime(endDate.year, endDate.month, endDate.day)).inDays;
  }
  ...
  static List<DateTime?> getMonthDays(List<DateTime> dateTime) {
    ...
    final newFirstDateTime = firstDate.subtract(
