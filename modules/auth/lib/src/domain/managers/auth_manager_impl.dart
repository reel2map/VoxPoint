...
class AuthManagerImpl extends AuthManager<UserEntity> {
  ...
  final BehaviorSubject<UserEntity> _user = BehaviorSubject.seeded(
  ...
  Future<void> init() async {
    ...
    final bool hasAccessToken = await authRepository.hasAccessToken();
  ...
  Future<void> _initSettings() async {
    ...
    settings = AuthSettings(
      ...
      useLocalAuth: useLocalAuth ?? settings.useLocalAuth,
    );
  }
  ...
  Future<void> block({Duration? value}) async {
    await authRepository.blockUser(
      DateTime.now().add(value ?? Env.blockSeconds),
    );
  ...
  Future<Either<Failure, UserEntity>> verify() async {
    ...
    final user = await authRepository.verify(deviceId: _deviceInfo.deviceId);
  ...
  @override
  Future<Either<Failure, bool>> signInOAuth() async {
    final result = await authRepository.signInOAuth();
