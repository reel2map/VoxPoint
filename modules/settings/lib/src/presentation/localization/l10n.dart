...
class SettingsI18n {
  ...
  static String get theme =>
      Intl.message('Theme', desc: 'Theme', name: 'SettingsI18n_theme');
  ...
  static String get darkTheme =>
      Intl.message('Dark', desc: 'Dark theme', name: 'SettingsI18n_darkTheme');
  ...
  static String get reset =>
      Intl.message('Reset', desc: 'Reset', name: 'SettingsI18n_reset');

  static String get delete =>
      Intl.message('Delete', desc: 'Delete', name: 'SettingsI18n_delete');
  ...
  static String get pushNotificationSettings => Intl.message(
    'System push notification',
    desc: 'Use biometrics to login?',
    name: 'SettingsI18n_pushNotificationSettings',
  );

  static String get clientPushNotificationSettings => Intl.message(
    'Client push notification',
    desc: 'Use biometrics to login?',
    name: 'SettingsI18n_clientPushNotificationSettings',
  );
}
