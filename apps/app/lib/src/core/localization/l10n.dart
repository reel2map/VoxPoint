...
class CoreI18n {
  ...
  static String get no => Intl.message('No', desc: 'No', name: 'CoreI18n_no');

  static String get yes =>
      Intl.message('Yes', desc: 'Yes', name: 'CoreI18n_yes');
  ...
  static String get goHome =>
      Intl.message('На главную', desc: 'На главную', name: 'CoreI18n_goHome');
}
